      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">کابل، افغانستان، خیابان اصلی، مکتب رهنورد دانش</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+93 700 000 000</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@rahwardanish.edu.af</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">شنبه تا چهارشنبه: ۸ صبح تا ۴ بعدازظهر</p>
            ...
            <div className="mt-8">
              <h3 className="font-bold text-gray-800 mb-4">شبکه‌های اجتماعی</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label className="block text-gray-700 mb-2" htmlFor="subject">موضوع</label>
                <input
                  type="text"
                  id="subject"
                  name="subject"
